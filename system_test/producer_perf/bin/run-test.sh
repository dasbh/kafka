...
(
export KAFKA_LOG4J_OPTS="-Dlog4j.configuration=file:$base_dir/../../config/test-log4j.properties"
...
$base_dir/../../bin/kafka-run-class.sh kafka.perf.ProducerPerformance --broker-list localhost:9092 --topics test01 --messages $num_messages --message-size $message_size --batch-size 200 --threads 1 --reporting-interval 100000 num_messages #--sync
)
